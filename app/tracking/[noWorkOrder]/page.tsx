            ...
            <div className="rounded-[20px] sm:rounded-[24px] border border-white/70 bg-white/85 p-4 sm:p-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {data.admin_whatsapp && (
                    <a href={`https://wa.me/${data.admin_whatsapp.replace(/\D/g, '').replace(/^0/, '62')}?text=${encodeURIComponent(`Halo Admin AYRES, saya ingin bertanya tentang WO ${data.no_wo}`)}`} target="_blank" rel="noreferrer"
