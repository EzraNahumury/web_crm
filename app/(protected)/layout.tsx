      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="shrink-0 h-14 flex items-center justify-between px-6 border-b border-white/[0.06] bg-[#0a0e17] sticky top-0 z-30 backdrop-blur">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              className="text-slate-500 hover:text-slate-200 hover:bg-white/[0.04] transition-colors p-1.5 rounded-lg"
              title="Refresh"
            >
              <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" /></svg>
            </button>
            <button
