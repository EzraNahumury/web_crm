...
export async function POST(req: NextRequest) {
  try {
    ...
    const menuAccess = row.is_super_admin
      ? ['Dashboard', 'CS Selling', 'CS Order', 'Orders', 'Work Orders', 'Produksi', 'Monitoring Produksi', 'Approval Gudang', 'CRM Deadline Lock', 'CRM Finishing', 'Laporan', 'Stok', 'Settings', 'Master Data', 'Analisa']
